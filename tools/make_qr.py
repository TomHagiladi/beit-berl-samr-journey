...
Outputs:
  qr_samr.png  - print-quality PNG (also copied to the Drive meeting folder later)
  qr_samr.svg  - compact SVG path, embedded into slides.html
...
URL = "https://tomhagiladi.github.io/beit-berl-samr-journey/"
OUT = r"C:\Users\tomha\AppData\Local\Temp\claude\C--Users-tomha-claude-code-workshops\a906e0e1-c13a-44fd-931b-86a084bbb6c6\scratchpad"
...
with open(OUT + r"\qr_samr.svg", "wb") as f:
    f.write(svg_bytes)
...
decoded = zxingcpp.read_barcode(Image.open(OUT + r"\qr_samr.png"))
